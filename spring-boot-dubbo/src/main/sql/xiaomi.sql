...
-- ----------------------------
BEGIN;
INSERT INTO `menu` VALUES (1, '小米手机', 0, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (2, '红米', 1, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (3, '电视', 2, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (4, '笔记本', 3, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (5, '家电', 4, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (6, '新品', 5, 'https://www.mi.com/p/2848.html', '1545299520812');
INSERT INTO `menu` VALUES (7, '路由器', 6, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (8, '智能硬件', 7, 'https://www.mi.com', '1545299520812');
INSERT INTO `menu` VALUES (9, '服务', 8, 'https://www.mi.com/service/', '1545299520812');
INSERT INTO `menu` VALUES (10, '社区', 9, 'http://www.xiaomi.cn/', '1545299520812');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `view_type_action` VALUES (1, 1, 'plugin', 'ShopPlugin://com.xiaomi.shop2.plugin.goodsdetail.GoodsDetailFragment?pluginId=101', '{\"goodsId\":\"\",\"commodityId\":\"10000099\",\"productId\":\"10000099\"}', '31apphomegallery001003#t=ad&act=product&page=home&pid=10000099&page_id=6707&bid=3312427.1&adp=2490&adm=10366');
INSERT INTO `view_type_action` VALUES (2, 2, 'plugin', 'ShopPlugin://com.xiaomi.shop2.plugin.goodsdetail.GoodsDetailFragment?pluginId=101', '{\"goodsId\":\"\",\"commodityId\":\"10000117\",\"productId\":\"10000117\"}', '31apphomegallery002003#t=ad&act=product&page=home&pid=10000117&page_id=6707&bid=3312427.2&adp=2681&adm=9237');
...
-- ----------------------------
BEGIN;
INSERT INTO `view_type_item` VALUES (1, NULL, 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/aa7402740d7388413c1160a315f5308c.jpg?w=1080&h=768&bg=FFFFFF', 'https://cdn.cnbj1.fds.api.mi-img.com/mi-mall/aa7402740d7388413c1160a315f5308c.jpg?f=webp&w=1080&h=768&bg=FFFFFF', '#FFFFFF', 00000001080, 00000000768, 2490, 10366, 'gallery', NULL);
INSERT INTO `view_type_item` VALUES (2, NULL, 'https://i8.mifile.cn/b2c-mimall-media/6b185a5261c85931c7d3cb916d99dec0.jpg?w=1080&h=768&bg=9DBCE8', 'http://i8.mifile.cn/v1/a1/9d5ef021-b2f6-f0ee-3a96-1c4cba6be619.webp?w=1080&h=768&bg=9DBCE8', '#9DBCE8', 00000001080, 00000000768, 2681, 9237, 'gallery', NULL);
